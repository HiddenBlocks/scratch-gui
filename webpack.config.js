...
const buildConfig = baseConfig.clone()
    ...
    .addPlugin(new HtmlWebpackPlugin({
        ...
        title: 'Hidden Blocks Scratch GUI'
    }))
    .addPlugin(new HtmlWebpackPlugin({
        ...commonHtmlWebpackPluginOptions,
        chunks: ['blocksonly'],
        ...
        template: 'src/playground/index.ejs',
        title: 'Hidden Blocks Scratch GUI: Blocks Only Example'
    }))
    .addPlugin(new HtmlWebpackPlugin({
        ...commonHtmlWebpackPluginOptions,
        ...
        template: 'src/playground/index.ejs',
        title: 'Hidden Blocks Scratch GUI: Compatibility Testing'
    }))
    .addPlugin(new HtmlWebpackPlugin({
        ...commonHtmlWebpackPluginOptions,
        chunks: ['player'],
        ...
        template: 'src/playground/index.ejs',
        title: 'Hidden Blocks Scratch GUI: Player Example'
    }))
    .addPlugin(new CopyWebpackPlugin({
        patterns: [
            {
